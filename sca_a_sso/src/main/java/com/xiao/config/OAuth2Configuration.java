...
public class OAuth2Configuration extends AuthorizationServerConfigurerAdapter {
    ...
    @Autowired
    @Qualifier(value="oauth2DataSource")
    ...
    public void configure(ClientDetailsServiceConfigurer clients) throws Exception {
        ...
        /*clients
              .inMemory()   //这里我们直接硬编码创建，当然也可以像Security那样自定义或是使用JDBC从数据库读取
                .withClient("web","app","WXAPP")   //客户端名称，随便起就行
                ...
                .redirectUris("http://localhost:8002/login")   //可以写多个，当有多个时需要在验证请求中指定使用哪个地址进行回调
    ...
    public void configure(AuthorizationServerEndpointsConfigurer endpoints) {
        endpoints.tokenServices(serverTokenServices())   //设定为刚刚配置好的AuthorizationServerTokenServices
